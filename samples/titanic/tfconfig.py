class TfConfig:
    ...
    TRAINING_DATA_FILE = "samples/titanic/train.csv"
    PREDICT_INPUT_FILE = "samples/titanic/test.csv"
    LABEL_NAME = "Survived"
    NUMERICAL_FEATURE_COLUMNS = ["Age","SibSp","Pclass"]
    ...
    CATEGORICAL_FEATURE_COLUMNS = [("Cabin",1000),("Sex",2)]
    ...
    CATEGORICAL_FEATURE_BUCKETIZED_COLUMNS = [("Fare",0, 500, 50)]
